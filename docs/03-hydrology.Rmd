...
<!-- Verification of modeling results was first performed by evaluating the annual runoff amounts over the historic period of record as a percentage of annual precipitation. Figures \@ref(fig:figQplots1) through \@ref(fig:figQplots4) annual runoff results for the Seattle-Tacoma International Airport.   -->

<!-- ```{r seatac, fig.cap="SEatac", fig.height=7, include=FALSE} -->
...
<!-- } -->
<!-- hrus <- read_csv("data/hrus.csv") -->
<!-- AnnualQEverettSeatacTacoma <-read_csv("data/AnnualPrecipEverettSeatacTacoma.csv") -->
...
<!-- Cig_seatac_Precip <- read_csv("data/ID16_V7_precip.csv") -->
...
<!-- ```{r figQplots1, echo=FALSE, fig.cap="Annual Runoff as a percentage of precipitation for outwash soils", fig.height=6} -->
<!-- qPlots[[1]] -->
<!-- ``` -->
<!-- ```{r figQplots2, echo=FALSE, fig.cap="Annual Runoff as a percentage of precipitation for till soils", fig.height=6} -->
<!-- qPlots[[2]] -->
<!-- ``` -->
<!-- ```{r figQplots3, echo=FALSE, fig.cap="Annual Runoff as a percentage of precipitation for saturated soils", fig.height=6} -->
<!-- qPlots[[3]] -->
<!-- ``` -->
<!-- ```{r figQplots4, echo=FALSE, fig.cap="Annual Runoff as a percentage of precipitation for impervious land cover", fig.height=4} -->
<!-- qPlots[[4]] -->
<!-- ``` -->
...
Daily streamflow data for the Madsen Creek watershed was provided by King County for the period 1991-2010. We delineated the watershed above the gaging site using the USGS NHDPLus flow-conditioned raster [@moore2019user]. 
...
\begin{equation}
  ...
  (\#eq:fdr)
\end{equation}0.08Q_2<q\ \le\ Q_{50};0.08Q_2<q\ \le\ Q_{50}
